...
from backend.core.revision_agents import ProgressiveRevisionAgent
...
revision_agent: ProgressiveRevisionAgent = None
mongodb_client: MongoDBClient = None

def set_dependencies(ra: ProgressiveRevisionAgent, mc: MongoDBClient):
